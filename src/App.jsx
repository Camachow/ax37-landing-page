  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 w-full bg-background/95 backdrop-blur-sm border-b border-border z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            <a href="#inicio" className="text-foreground hover:text-accent transition-colors font-medium">Início</a>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Somos especialistas em marketing e montagem de eventos, exposições e experiências corporativas. 
                  Com mais de 10 anos de experiência, criamos estratégias que conectam marcas ao seu público-alvo 
                  de forma impactante e memorável.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-accent/10 to-accent/20 rounded-3xl flex items-center justify-center shadow-2xl border border-accent/20">
                <div className="text-center space-y-6">
                  <div className="w-32 h-32 bg-accent/20 rounded-full flex items-center justify-center mx-auto shadow-lg border border-accent/30">
                    <Building2 className="w-16 h-16 text-accent" />
                  </div>
                  <div className="space-y-2">
                    <p className="text-2xl font-bold text-foreground">Marketing</p>
                    <p className="text-xl font-semibold text-accent">que Conecta</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="servicos" className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-accent/10 text-accent border-accent/20">Nossos Serviços</Badge>
            <h2 className="text-4xl font-bold text-foreground">Soluções Completas em Marketing de Eventos</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Oferecemos serviços especializados em marketing e montagem de eventos, desde o planejamento estratégico 
              até a execução, garantindo que cada projeto seja único e impactante.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Stands Personalizados</CardTitle>
              </CardHeader>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Estratégia de Marketing</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base text-muted-foreground">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Tecnologia Audiovisual</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base text-muted-foreground">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Experiências Imersivas</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base text-muted-foreground">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Gestão Completa</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base text-muted-foreground">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-foreground">Branding e Identidade</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base text-muted-foreground">
      ...
      <section id="portfolio" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-accent/10 text-accent border-accent/20">Nosso Portfólio</Badge>
            <h2 className="text-4xl font-bold text-foreground">Eventos que Marcaram História</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Cada projeto é único e especial. Veja alguns dos nossos trabalhos mais marcantes em marketing de eventos, 
              exposições e experiências corporativas.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <Card key={item} className="group overflow-hidden border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300">
                <div className="aspect-video bg-gradient-to-br from-accent/10 to-accent/20 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <Badge className="bg-background/90 text-foreground border-accent/20">
                      {item % 3 === 1 ? 'Evento Corporativo' : item % 3 === 2 ? 'Feira Tecnológica' : 'Lançamento de Produto'}
                    </Badge>
                  </div>
                </div>
                <CardContent className="p-6">
                  <h3 className="text-lg font-semibold mb-2 text-foreground">
                    {item % 3 === 1 ? 'Summit Inovação 2024' : item % 3 === 2 ? 'TechExpo Brasil' : 'Lançamento StartupX'}
                  </h3>
                  <p className="text-muted-foreground text-sm">
                    {item % 3 === 1 
                      ? 'Evento corporativo para 500 executivos com estratégia de marketing integrada e experiências imersivas.'
                      : item % 3 === 2 
                      ? 'Feira tecnológica com 100 expositores, gestão completa e campanhas de marketing digital.'
                      : 'Lançamento de produto com experiência de marca única e cobertura de mídia especializada.'
                    }
                  </p>
                </CardContent>
              </Card>
      ...
      <section id="contato" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-accent/10 text-accent border-accent/20">Entre em Contato</Badge>
            <h2 className="text-4xl font-bold text-foreground">Vamos Criar Seu Próximo Evento</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Estamos prontos para transformar sua visão em realidade. Entre em contato conosco e vamos começar a planejar seu evento perfeito.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-foreground mb-2 block">Tipo de Evento</label>
                ...
                <div>
                  ...
                  <Textarea placeholder="Conte-nos mais sobre seu projeto..." rows={4} className="border-border focus:border-accent" />
                </div>
            ...
            <div className="space-y-8">
              <Card className="border-border">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-foreground">Telefone</h3>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">contato@ax37marketing.com</p>
                      <p className="text-muted-foreground">orcamento@ax37marketing.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Rua dos Eventos, 123</p>
              ...
              <div className="bg-card rounded-lg p-6 border border-border">
                <h3 className="font-semibold text-lg mb-4 text-foreground">Horário de Atendimento</h3>
      ...
      <footer className="bg-primary text-primary-foreground py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-primary-foreground/80">
                Especialistas em marketing de eventos, criando experiências que conectam marcas ao seu público-alvo.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-foreground/80">
                <li><a href="#" className="hover:text-accent transition-colors">Stands Personalizados</a></li>
                <li><a href="#" className="hover:text-accent transition-colors">Estratégia de Marketing</a></li>
                <li><a href="#" className="hover:text-accent transition-colors">Tecnologia Audiovisual</a></li>
                <li><a href="#" className="hover:text-accent transition-colors">Experiências Imersivas</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-primary-foreground/80">
            <p>&copy; 2025 AX37 Marketing Eventos. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
